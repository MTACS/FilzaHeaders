...
@class GDBoxMetadata, NSDate, NSDictionary, NSString, NSURL;

__attribute__((visibility("hidden")))
@interface GDBoxURLMetadata : NSObject <GDURLMetadata>
{
    GDBoxMetadata *_metadata;
}

@property(readonly, nonatomic) GDBoxMetadata *metadata; // @synthesize metadata=_metadata;
- (void).cxx_destruct;
- (_Bool)isValid;
...
- (id)initWithBoxMetadata:(id)arg1;
