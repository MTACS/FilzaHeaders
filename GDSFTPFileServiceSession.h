...
@interface GDSFTPFileServiceSession : GDRemoteFileServiceSession
{
}
...
- (id)clientMetadataForSFTPMetadata:(id)arg1;
...
@property(retain, nonatomic) GDSFTPClient *client; // @dynamic client;
