...
@class GDBoxAPIToken, GDOAuth2Credential, NSString;

__attribute__((visibility("hidden")))
@interface GDBoxClient : GDHTTPClient
{
...
- (id)boxFileIDFromFileID:(id)arg1;
...
@property(readonly, nonatomic) GDBoxAPIToken *apiToken; // @dynamic apiToken;
