...
@class GDSMBClientManager;

__attribute__((visibility("hidden")))
@interface GDSMBFileService : GDRemoteFileService
{
}
...
@property(readonly, nonatomic) GDSMBClientManager *clientManager; // @dynamic clientManager;
