...
@class GTMSessionUploadFetcher, NSArray, NSData, NSDate, NSDictionary, NSError, NSHTTPCookieStorage, NSMutableData, NSMutableDictionary, NSMutableURLRequest, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSString, NSTimer, NSURL, NSURLCredential, NSURLRequest, NSURLResponse, NSURLSession, NSURLSessionConfiguration, NSURLSessionTask;
