...
@class GDFTPMetadata, NSDate, NSDictionary, NSString, NSURL;

__attribute__((visibility("hidden")))
@interface GDFTPURLMetadata : NSObject <GDURLMetadata>
{
    NSString *_FTPPath;
    GDFTPMetadata *_metadata;
}

@property(readonly, nonatomic) GDFTPMetadata *metadata; // @synthesize metadata=_metadata;
@property(readonly, copy, nonatomic) NSString *FTPPath; // @synthesize FTPPath=_FTPPath;
- (void).cxx_destruct;
- (_Bool)isValid;
...
@property(readonly, copy, nonatomic) NSString *fileVersionIdentifier; // @dynamic fileVersionIdentifier;
...
- (id)initWithFTPMetadata:(id)arg1;
