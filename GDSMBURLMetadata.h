...
@class GDSMBMetadata, NSDate, NSDictionary, NSString, NSURL;

__attribute__((visibility("hidden")))
@interface GDSMBURLMetadata : NSObject <GDURLMetadata>
{
    NSString *_SMBPath;
    GDSMBMetadata *_metadata;
}

@property(readonly, nonatomic) GDSMBMetadata *metadata; // @synthesize metadata=_metadata;
@property(readonly, copy, nonatomic) NSString *SMBPath; // @synthesize SMBPath=_SMBPath;
- (void).cxx_destruct;
- (_Bool)isValid;
...
- (id)initWithSMBMetadata:(id)arg1;
