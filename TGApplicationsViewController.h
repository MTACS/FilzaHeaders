...
@class MIInstallerClient;

__attribute__((visibility("hidden")))
@interface TGApplicationsViewController : TGPageViewController
{
    _Bool _isLoading;
    MIInstallerClient *_client;
}

@property(nonatomic) _Bool isLoading; // @synthesize isLoading=_isLoading;
@property(retain, nonatomic) MIInstallerClient *client; // @synthesize client=_client;
- (void).cxx_destruct;
