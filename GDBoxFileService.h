...
@class GDBoxClientManager;

__attribute__((visibility("hidden")))
@interface GDBoxFileService : GDRemoteFileService
{
}
...
@property(readonly, nonatomic) GDBoxClientManager *clientManager; // @dynamic clientManager;
