...
@class GDOneDriveClient;

__attribute__((visibility("hidden")))
@interface GDOneDriveFileServiceSession : GDRemoteFileServiceSession
{
}
...
- (id)clientMetadataForOneDriveMetadata:(id)arg1 parentURL:(id)arg2 clientURL:(id)arg3;
- (void)searchAtURL:(id)arg1 withName:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
- (id)clientMetadataForOneDriveMetadata:(id)arg1 clientURL:(id)arg2;
- (id)clientMetadataForOneDriveMetadata:(id)arg1 parentURL:(id)arg2;
...
- (id)uploadFileURL:(id)arg1 filename:(id)arg2 mimeType:(id)arg3 toParentFolderURL:(id)arg4 internalUploadState:(id)arg5 uploadStateHandler:(CDUnknownBlockType)arg6 progress:(CDUnknownBlockType)arg7 success:(CDUnknownBlockType)arg8 failure:(CDUnknownBlockType)arg9;
...
@property(retain, nonatomic) GDOneDriveClient *client; // @dynamic client;
