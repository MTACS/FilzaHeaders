...
@interface GDBoxFileServiceSession : GDRemoteFileServiceSession
{
}
...
- (id)clientMetadataForBoxMetadata:(id)arg1 parentURL:(id)arg2 clientURL:(id)arg3;
- (void)searchAtURL:(id)arg1 withName:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
- (id)clientMetadataForBoxMetadata:(id)arg1 clientURL:(id)arg2;
- (id)clientMetadataForBoxMetadata:(id)arg1 parentURL:(id)arg2;
...
@property(retain, nonatomic) GDBoxClient *client; // @dynamic client;
