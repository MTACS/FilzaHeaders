...
@class MBProgressHUD, MWGridViewController, NSArray, NSMutableSet, NSString, NSTimer, UIActionSheet, UIActivityViewController, UIBarButtonItem, UIColor, UIImage, UIPopoverController, UIScrollView, UIToolbar;

@interface MWPhotoBrowser : UIViewController <UIScrollViewDelegate, UIActionSheetDelegate, MFMailComposeViewControllerDelegate>
{
    unsigned long long _photoCount;
    id <MWPhoto> _currentThumbPhoto;
    unsigned long long _currentThumbPhotoIndex;
    id <MWPhoto> _currentPhoto;
    ...
    UIBarButtonItem *_caption;
    UIBarButtonItem *_captionFlex;
    UIPopoverController *_actionController;
...
@property(retain, nonatomic) UIPopoverController *actionController; // @synthesize actionController=_actionController;
@property(retain, nonatomic) UIBarButtonItem *captionFlex; // @synthesize captionFlex=_captionFlex;
@property(retain, nonatomic) UIBarButtonItem *caption; // @synthesize caption=_caption;
...
- (id)placeholderPhotoAtIndex:(unsigned long long)arg1;
- (id)thumbPhotoAtIndex:(unsigned long long)arg1 asyncLoadingImage:(CDUnknownBlockType)arg2;
- (id)photoAtIndex:(unsigned long long)arg1 asyncLoadingImage:(CDUnknownBlockType)arg2;
