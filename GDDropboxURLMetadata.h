...
@class GDDropboxMetadata, NSDate, NSDictionary, NSString, NSURL;

__attribute__((visibility("hidden")))
@interface GDDropboxURLMetadata : NSObject <GDURLMetadata>
{
    GDDropboxMetadata *_metadata;
}

@property(readonly, nonatomic) GDDropboxMetadata *metadata; // @synthesize metadata=_metadata;
- (void).cxx_destruct;
- (_Bool)isValid;
...
- (id)initWithDropboxMetadata:(id)arg1;
