...
@class GDOneDriveClientManager;

__attribute__((visibility("hidden")))
@interface GDOneDriveFileService : GDRemoteFileService
{
}
...
@property(readonly, nonatomic) GDOneDriveClientManager *clientManager; // @dynamic clientManager;
